...
public class CutiTahunan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.cuti_tahunan);
    ...
    private void listDinasLuar(String NIP)
    {
        ...
        JsonArrayRequest sptRequest = new JsonArrayRequest(Config.StringUrl.data_cuti_tahunan_by_nik+"?nik="+NIP,new Response.Listener<JSONArray>() {
            @Override
    ...
    {
        dialog = new AlertDialog.Builder(CutiTahunan.this);
        inflater_dialog = LayoutInflater.from(CutiTahunan.this);
        dialogView = inflater_dialog.inflate(R.layout.cuti_tahunan_form, null);
        ...
        tanggal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DatePickerDialog(CutiTahunan.this, dateTanggal, myCalendar
        ...
        tanggal_antara.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DatePickerDialog(CutiTahunan.this, dateTanggal_antara, myCalendar
                        .get(Calendar.YEAR), myCalendar.get(Calendar.MONTH),
                        myCalendar.get(Calendar.DAY_OF_MONTH)).show();
            }
        });
    ...
    public void simpanForm()
    {
        ...
        try {
            ...
            String URL = Config.StringUrl.set_form_cuti_tahunan;
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        finish();
                        Intent i = new Intent(getApplicationContext(), CutiTahunan.class);
                        startActivity(i);
                    }catch (Exception e)
                    {
