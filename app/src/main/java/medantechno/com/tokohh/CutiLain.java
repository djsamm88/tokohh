...
public class CutiLain extends AppCompatActivity {
    ...
    private void list(String NIP)
    {
        ...
        JsonArrayRequest sptRequest = new JsonArrayRequest(Config.StringUrl.data_cuti_lain_by_nik+"?nik="+NIP,new Response.Listener<JSONArray>() {
            @Override
    ...
    {
        dialog = new AlertDialog.Builder(CutiLain.this);
        inflater_dialog = LayoutInflater.from(CutiLain.this);
        dialogView = inflater_dialog.inflate(R.layout.cuti_lain_form, null);
        ...
        tanggal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DatePickerDialog(CutiLain.this, dateTanggal, myCalendar
    ...
    public void simpanForm()
    {
        ...
        try {
            ...
            String URL = Config.StringUrl.set_form_cuti_lain;
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        finish();
                        Intent i = new Intent(getApplicationContext(), CutiLain.class);
                        startActivity(i);
                    }catch (Exception e)
                    {
