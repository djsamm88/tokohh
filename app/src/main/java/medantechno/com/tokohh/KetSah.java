...
public class KetSah extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ket_sah);
    ...
    private void list(String NIP)
    {
        ...
        JsonArrayRequest sptRequest = new JsonArrayRequest(Config.StringUrl.data_sakit_by_nik+"?nik="+NIP,new Response.Listener<JSONArray>() {
            @Override
    ...
    {
        dialog = new AlertDialog.Builder(KetSah.this);
        inflater_dialog = LayoutInflater.from(KetSah.this);
        dialogView = inflater_dialog.inflate(R.layout.ket_sah_form, null);
        dialog.setView(dialogView);
        dialog.setCancelable(false);
        dialog.setTitle("Form Ket. Sah");
        ...
        tanggal.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                new DatePickerDialog(KetSah.this, dateTanggal, myCalendar
    ...
    public void simpanForm()
    {
        ...
        try {
            ...
            String URL = Config.StringUrl.set_form_sakit;
            ...
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URL, new Response.Listener<String>() {
                ...
                public void onResponse(String response) {
                    ...
                    try {
                        finish();
                        Intent i = new Intent(getApplicationContext(), KetSah.class);
                        startActivity(i);
                    }catch (Exception e)
                    {
